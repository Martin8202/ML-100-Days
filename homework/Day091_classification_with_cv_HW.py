...
如果你看到非常低的準確率，別懷疑，就是那麼低！到這裡大致可以體會到，
靠人工設計的特徵在簡單的任務上也許是堪用（該例子如果用的是 mnist 數據集，
準確應該還是可以有 90% 以上，有興趣的可以自己嘗試替換一下，或者參考這個範例來跑看看），
但複雜的情況，比如說分類的類別多起來，就能明顯感覺到這些特徵的不足之處了。